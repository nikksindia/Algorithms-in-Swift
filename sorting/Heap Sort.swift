...
// Things to remember ---------->>>>>> BFS in tree
// Construct Max Heap First
// then take out the first element (main root) and swap this with last element
// Construct heap again with reduces no. of elements
var array = [121,10,130,57,36,17]
...
let sortedArray = heapSort(inputArray: array)
print(sortedArray)
